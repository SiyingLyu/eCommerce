...
class MarketingPreferenceUpdateView(SuccessMessageMixin, UpdateView):
	...
	success_message = 'Your email perferences has been updated. Thank you!'
	...
	def get_context_data(self, *args, **kwargs):
		...
		context['title'] = 'Update Email Perferences'
		return context

	def get_object(self):
		user = self.request.user
		obj, created = MarketingPreference.objects.get_or_create(user=user) # onetoone field
		return obj
